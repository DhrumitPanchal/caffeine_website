...
import SimpleSlider from "./Itemsslider";
        ...
        <div className="relative flex justify-between flex-col max-sm:h-fit h-screen w-full bg-[#1b1107] max-sm:py-[3rem] max-sm:px-[4rem] py-[2rem] px-[7rem]">
          ...
          <div className="flex max-sm:flex-col max-sm:gap-[4rem] my-auto justify-between">
            <img
              ...
              alt=""
            />
            <div className="flex z-20 flex-col max-sm:gap-[1.5rem] gap-[1rem] max-sm:w-full max-sm:mt-[5rem] w-[35rem] text-white">
          ...
          <div className="flex max-sm:flex-col max-sm:gap-[5rem] gap-[20rem]">
            ...
            <div className="flex flex-col max-sm:items-center justify-center gap-[2rem]">
              ...
              <p className="text-[#1b1107] max-sm:text-[1.7rem] max-sm:leading-[2.3rem] max-sm:text-center text-[1.3rem] font-sans">
                ...
                Molestias ex maxime ipsum quasi aut non vel, a aspernatur
                eligendi odit facere nulla laboriosam quam quae porro officia
                dicta praesentium voluptatibus!
              </p>
        ...
        <div className="bg-[#ddb288] flex flex-col max-sm:gap-[10rem] gap-[5rem] max-sm:py-[7rem] py-[8rem] px-[6rem]">
          <div className="flex flex-col justify-center gap-[3rem] items-center">
            ...
            <p className="text-center text-[#1b1107] max-sm:text-[1.7rem] max-sm:leading-[2.3rem] max-sm:text-center text-[1.3rem] font-sans max-sm:w-full w-[60rem]">
              ...
              eligendi quae incidunt commodi sequi porro molestiae. Quas, quia
              molestiae hic impedit et necessitatibus illo ullam quam explicabo
              deserunt harum sunt?
            </p>
            <Itemsslider />
            {/* <SimpleSlider/> */}
...
<div className="bg-[#1a1106] flex max-sm:flex-col max-sm:py-[1rem] max-sm:px-[0] px-[7rem]  text-white">
  <div className="flex flex-col gap-[2rem] max-sm:w-full w-[42%] max-sm:px-[6rem] py-[6rem] px-[1.5rem] max-sm:border-x-[0] max-sm:border-b-[.1rem] border-x-[.1rem] border-[#ddb288]">
    <div className="w-full h-[20rem] flex justify-center items-center bg-[#c6ad8f] border-white border-[.4rem] text-[5.5rem] font-fonts text-[#1a1106]">Caffeine</div>
    <h2 className="text-[2rem] max-sm:text-center">Enjoy Better And Better Quality Coffee With Caffeine.</h2>
</div>
  <div className="flex flex-col gap-[2rem] max-sm:w-full w-[35%] max-sm:px-[6rem] py-[6rem] px-[1.5rem] text-[2rem]">
    <h2 className="text-[2.7rem] font-fonts max-sm:text-center">Contect Us</h2>
    <div className="max-sm:text-center">
      <h2>Caffeine@Gmail.com</h2>
      <h2>Call Us: <span className="">(321) 512 - 57420 </span></h2>
      <h2>Text Us: <span className="">(321) 512 - 57420 </span></h2>
    </div>
     <h2 className="mt-[1rem] ">
      39 Brookly Street Convington, VA 244426
     </h2>
  </div>
  <div className="flex flex-col gap-[3rem] max-sm:w-full w-[30%] max-sm:px-[6rem] py-[6rem] px-[1.5rem] max-sm:border-x-[0] max-sm:border-t-[.1rem] border-x-[.1rem] border-[#ddb288]">
   <div className="w-full max-sm:h-[20rem] h-[13rem] flex justify-center items-center  border-[#ddb288] border-[.2rem] text-[5.5rem] font-fonts text-[#1a1106]"></div>
   <div>
    <h2 className="text-[2.5rem] font-fonts max-sm:text-center">Follow Us</h2>
   </div>
  </div>
</div>
<div className="bg-[#1a1106] flex justify-center max-sm:py-[7rem] max-sm:py-[2rem] py-[2rem] px-[7rem] text-white border-t-[.1rem] border-[#ddb288]">
  <h2 className="text-[1.5rem]">@Devloped By Dhrumit</h2>
</div>
</section>
    </>
  );
